...
public:
    ...
    t_aggspec(std::string aggname, std::string disp_name, t_aggtype agg,
        const std::vector<t_dep>& dependencies);

    t_aggspec(std::string aggname, std::string disp_name, t_aggtype agg,
        const std::vector<t_dep>& dependencies, t_sorttype sort_type);

    t_aggspec(std::string aggname, std::string disp_aggname, t_aggtype agg,
    ...
    static std::vector<t_col_name_type> mk_col_name_type_vec(
        const std::string& name, t_dtype dtype);
